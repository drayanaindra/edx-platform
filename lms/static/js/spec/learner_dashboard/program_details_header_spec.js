define([
    ...
    describe('Program Details Header View', function() {
                    ...
                    authoring_organizations: [
                        {
                            ...
                            certificate_logo_image_url: 'https://edxuploads.s3.amazonaws.com/organization_logos/WUR_RGB_standard.png',
                            logo_image_url: 'https://www.edx.org/sites/default/files/school/image/logo/wageningenx-logo12022015-200x101.png',
                        }
                    ]
                }
            };
        ...
        it('should render the header based on the passed in model', function() {
            ...
            expect(view.$('.org-logo').attr('src')).toEqual(context.programData.authoring_organizations[0].certificate_logo_image_url);
            expect(view.$('.org-logo').attr('alt')).toEqual(
                    context.programData.authoring_organizations[0].name + '\'s logo'
                );
